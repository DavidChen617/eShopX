        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "Banner 標題"),
                    ImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false, comment: "圖片網址"),
                    Link = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false, comment: "點擊連結"),
                    ...
                    StartsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "生效開始時間"),
                    EndsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "生效結束時間"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, comment: "分類名稱"),
                    Icon = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, comment: "圖標（emoji 或 icon name）"),
                    Link = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false, comment: "點擊連結"),
                    SortOrder = table.Column<int>(type: "integer", nullable: false, defaultValue: 0, comment: "排序順序"),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true, comment: "是否啟用"),
                    ParentId = table.Column<Guid>(type: "uuid", nullable: true, comment: "父分類 ID（支援子分類）"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "homepage", comment: "推薦類型（homepage、category、similar 等）"),
                    SortOrder = table.Column<int>(type: "integer", nullable: false, defaultValue: 0, comment: "排序順序"),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true, comment: "是否啟用"),
                    StartsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "生效開始時間"),
                    EndsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "生效結束時間"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRecommends", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductRecommends_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRecommends_ProductId",
                table: "ProductRecommends",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductRecommends_RecommendType_IsActive_SortOrder",
                table: "ProductRecommends",
                columns: new[] { "RecommendType", "IsActive", "SortOrder" });
        }
