...
@Component({
  ...
  template: `
    <section class="flex min-h-[60dvh] items-center justify-center px-4 py-12">
      <div
        class="w-full max-w-md rounded-2xl border border-emerald-200 bg-emerald-50 p-6 text-center"
      >
        ...
        <a
          class="mt-5 inline-flex rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white"
          routerLink="/"
        >
          回首頁
        </a>
